// frontend/src/app/dashboard/student/exams/[examId]/report/page.tsx
import { createClient } from "@/lib/supabase/server";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import Link from "next/link";
import { BookOpen } from "lucide-react"; // Changed from recharts

// --- The 100x Predictive Grade Engine ---
...
export default async function ExamReportPage({ params }: { params: { examId: string } }) {
    ...
    // Generate topic performance heat map
